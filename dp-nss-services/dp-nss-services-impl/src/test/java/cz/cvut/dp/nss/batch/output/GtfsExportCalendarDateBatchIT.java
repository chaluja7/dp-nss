 ...
 * @since 07.01.17
 */
public class GtfsExportCalendarDateBatchIT extends AbstractServiceIT {
    ...
    public void textExport() throws Throwable {
        ...
        JobExecution execution = jobLauncher.run(gtfsExportCalendarDateBatchJob, new JobParameters(parameters));
