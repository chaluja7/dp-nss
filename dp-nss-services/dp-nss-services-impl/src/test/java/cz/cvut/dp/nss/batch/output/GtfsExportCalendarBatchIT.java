 ...
 * @since 07.01.17
 */
public class GtfsExportCalendarBatchIT extends AbstractServiceIT {
    ...
    public void textExport() throws Throwable {
        ...
        JobExecution execution = jobLauncher.run(gtfsExportCalendarBatchJob, new JobParameters(parameters));
