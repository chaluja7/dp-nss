 ...
 * @since 07.01.17
 */
public class GtfsExportStopTimeBatchIT extends AbstractServiceIT {
    ...
    public void textExport() throws Throwable {
        ...
        JobExecution execution = jobLauncher.run(gtfsExportStopTimeBatchJob, new JobParameters(parameters));
