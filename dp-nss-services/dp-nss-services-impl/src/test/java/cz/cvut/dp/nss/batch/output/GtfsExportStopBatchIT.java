 ...
 * @since 07.01.17
 */
public class GtfsExportStopBatchIT extends AbstractServiceIT {
    ...
    public void textExport() throws Throwable {
        ...
        JobExecution execution = jobLauncher.run(gtfsExportStopBatchJob, new JobParameters(parameters));
