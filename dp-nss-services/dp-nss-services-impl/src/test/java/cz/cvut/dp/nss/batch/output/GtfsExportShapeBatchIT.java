 ...
 * @since 07.01.17
 */
public class GtfsExportShapeBatchIT extends AbstractServiceIT {
    ...
    public void textExport() throws Throwable {
        ...
        JobExecution execution = jobLauncher.run(gtfsExportShapeBatchJob, new JobParameters(parameters));
