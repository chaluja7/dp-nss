...
/**
 * Komponenta seznamu prujezdnich bodu
 */
@Component({
    moduleId: module.id,
...
export class ShapesComponent extends AbstractFilteringComponent implements OnInit {
    ...
    /**
     * nastavi cislo stranky a provede vyhledavani
    ...
    /**
     * preskoci na detail
     * @param shapes prujezdni bod
     */
    goToDetail(shapes: Shapes): void {
        this.router.navigate(['/shape', shapes.id]);
    }
