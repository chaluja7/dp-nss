...
export class PagerService {
    ...
    /**
     * @param totalItems celkovy pocet polozek
     * @param currentPage aktualni stranka
     * @param pageSize velikost jedne stranky (pocet polozek na stranku)
     * @returns {Pager} pager dle parametru
     */
    ...
    /**
     * @param column radici sloupec
     * @param orderAsc true, pokud se dle sloupce ma radit vzestupne, false jinak
     * @returns {string} retezec pro hlavicku X-Order
     */
